...
public class ItemsProcessorApp {
                ...
                if (loggedInUser == 1){
                    ...
                    if (! managerWantsToClose){
                        ...
                        for(String item : newInventory){
                            ...
                            int qty = getItemQuantity(itemName);
                            
                            System.out.println(itemName + "\t" + qty + "\tR" + price);
                        }
    ...
    private static boolean validateManagerCredentials(String loginCredentials){
        ...
        System.out.println("Split \t" + Arrays.toString(splitCreds));
